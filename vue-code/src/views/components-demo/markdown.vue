<template>
  <div class="components-container">
    ...
    <div class="editor-container">
      ...
      <markdown-editor v-model="content1" height="300px"></markdown-editor>
    </div>
    ...
    <div class="editor-container">
      ...
      <markdown-editor ref="markdownEditor" v-model="content4" :language="language" height="300px"></markdown-editor>
    </div>
