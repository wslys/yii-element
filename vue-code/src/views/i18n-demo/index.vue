  ...
  <div>
    ...
    <el-row :gutter="20" style="margin:100px 15px 50px;">
      <el-col :span="12" :xs="24">
        <div class="block">
          <el-date-picker v-model="date" :placeholder="$t('i18nView.datePlaceholder')" type="date"></el-date-picker>
        </div>
        <div class="block">
      ...
      <el-col :span="12" :xs="24">
        <el-table :data="tableData" fit highlight-current-row border style="width: 100%">
          <el-table-column :label="$t('i18nView.tableName')" prop="name" width="100" align="center"></el-table-column>
          <el-table-column :label="$t('i18nView.tableDate')" prop="date" width="120" align="center"></el-table-column>
          <el-table-column :label="$t('i18nView.tableAddress')" prop="address"></el-table-column>
        </el-table>
      </el-col>
    </el-row>
  </div>
